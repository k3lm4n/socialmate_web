    ...
    <aside className="h-screen lg:w-20 w-16  fixed ">
      <nav>
        <ul className="flex flex-col items-center">
          <li className=" lg:w-11 lg:h-11 mt-5 mb-2 rounded-xl bg-blue-50 hover:shadow-inner transition-all  duration-500">
            <Link
          ...
          <ListGroup />
          <li className="flex items-center justify-center lg:w-11 w-8 lg:h-11 h-8 my-2 rounded-full bg-white hover:shadow-inner transition-all duration-300">
            <Link
              href={"/dashboard"}
              className=" flex items-center justify-center lg:w-11 w-8 lg:h-11 h-8"
            >
